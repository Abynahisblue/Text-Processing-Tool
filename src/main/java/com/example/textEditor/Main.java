...
import com.example.textEditor.controller.TextController;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            FXMLLoader regexLoader = new FXMLLoader(getClass().getResource("/com/example/textEditor/TextView.fxml"));
            VBox root = new VBox();
